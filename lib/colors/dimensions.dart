...
class Dimensions{
     ...
     static double screenHeight = Get.context!.height; //932
     static double screenWidth = Get.context!.width;  //430
    ...
    //list view size 
     ...
     static double listViewTextConstSize = screenWidth/4.3;

    //FoddDetails 
     static double foodDetailImgSize = screenHeight/2.66;
